...
//        System.out.println(cbSupplyer.getPromptText());
        ...
        if (isNotNull()) {
            ...
            pst.setString(1, supplyerId);
            pst.setString(2, brandId);
            pst.setString(3, cmbCatagory.getValue().toString());
            rs = pst.executeQuery();
            while (rs.next()) {
    ...
    public void viewSelected() {
        ...
        System.out.println("category current="+currentProduct.catagoryId+"  categori "+catagoryId);
    ...
    public void btnAddSupplierOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            supplyerController.lblCaption.setText("Ajouter un fournisseur");
    ...
    public void btnAddCatagoryOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            catagoryController.lblHeaderContent.setText("Ajouter Categorie");
    ...
    public void btnAddUnitOnAction(ActionEvent actionEvent) {
        ...
        try {
            ...
            unitController.lblContent.setText("Ajouter Unite");
