...
public class ViewSellController implements Initializable{
    ...
    private void viewSelected() {
        SellUpController apc = new SellUpController();
        userNameMedia userMedia = new userNameMedia();
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("/view/application/sell/sellUp.fxml"));
        try {
            fxmlLoader.load();
            Parent parent = fxmlLoader.getRoot();
            Scene scene = new Scene(parent);
            scene.setFill(new Color(0, 0, 0, 0));
            SellUpController addProductController = fxmlLoader.getController();
      
            addProductController.currentSell.Id = tblSellView.getSelectionModel().getSelectedItem().getId();
            addProductController.cusstumer_Name = tblSellView.getSelectionModel().getSelectedItem().getCustomerName();
            addProductController.currentProduct.id = tblSellView.getSelectionModel().getSelectedItem().getProductId();
    ...
    @FXML
    private void modifierQnt(ActionEvent event) {
