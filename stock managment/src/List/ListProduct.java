...
public class ListProduct {
    ...
    public ListProduct(String id, String productId, String productName, String quantity, String description, String suppliedBy, String brand, String catagory, String unit, String pursesPrice, String sellPrice, String user, String date) {
        this.id = id;
